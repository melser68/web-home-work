...
dict_suffix_res = {
    "suffix_images": suffix_images,
    "suffix_archives": suffix_archives,
    "suffix_videos": suffix_videos,
    "suffix_documents": suffix_documents,
    "suffix_musics": suffix_musics,
    "suffix_others": suffix_other,
...
dict_sorting_files = {
    ...
    "res_archives": res_archives,
    "res_videos": res_videos,
    "res_documents": res_documents,
    "res_musics": res_musics,
...
def unpack_archive(dyrectory_for_inpack):
    try:
        ...
        for archive in os.listdir(folder_archive):
            if (
                Path(archive).suffix == ".zip"
                or Path(archive).suffix == ".tar"
                or Path(archive).suffix == ".gz"
            ):
